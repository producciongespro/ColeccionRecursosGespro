...
$sql= "SELECT recursos.id, recursos.nombre, recursos.etiqueta, recursos.urlImg, recursos.url, recursos.ciclo, recursos.materia, recursos.seccion, secciones.nombre AS seccion FROM recursos INNER JOIN secciones ON recursos.seccion = secciones.id WHERE recursos.borrado = 1 ORDER BY recursos.id DESC";
